...
public class StringAPI {
	...
	public static void main(String[] args) {
		...
		System.out.println(title.indexOf("프로그래밍")); // 3 반환: 문자열의 4번째부터 시작함
		...
		System.out.println(title.substring(3,5));//3번부터 4번까지 인덱스 추출
		...
		String[] names = str.split("&|,|-"); // & 이나 , 이나 - 을 기준으로 분리하고 배열반환
