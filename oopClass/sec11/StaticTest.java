...
public class StaticTest {
	...
	int a;
//	void f1(int x) {a=x;} //인스턴스 메서드에서 인스턴스 필드 사용 가능
//	void f2(int x) {b=x;} //인스턴스 메서드에서 static 필드 사용 가능
...
//	static void s3(int x) {b=x;} //static 메소드 static 필드 사용 가능
//	static void s4(int x) {s1(x);} //static 메소드 static 메소드 호출 가능
